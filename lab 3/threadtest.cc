...
void TestValueOne()
{
	...
	Thread *t1 = new Thread("inc_v1a");
        Thread *t2 = new Thread("inc_v1b");
        Thread *t3 = new Thread("dec_v1a");
        Thread *t4 = new Thread("dec_v1b");
...
void TestValueMinusOne()
{
	...
	//fill your code
	Thread *t1 = new Thread("inc_v2a");
	Thread *t2 = new Thread("inc_v2b");
	Thread *t3 = new Thread("dec_v2a");
	Thread *t4 = new Thread("dec_v2b");
...
void TestConsistency()
{
	...
	Thread *t4 = new Thread("dec_consistent2");
